...
Pump type filters are excellent for their ability to fill multiple containers 
...
Essentially, tarps are some of the most useful objects you can have to fit a 
...
At home you can make tinder by rubbing cotton balls in petroleum jelly. These 
...
Acquiring proteins in nature is usually accomplished through hunting, trapping, 
...
Remember, if you kill it, you eat it (so long as it isn’t diseased). Here are 
...
Have a salt plan. If you can source it locally in the wilderness, you are lucky.
...
Lensatic compass are rugged and reliable means of navigation. Buy a quality one 
...
during the day). Here is an introductory guide to using these compasses:
...
The last item you will need is a pace counter (also called ranger beads). This 
...
your pace count, and utilizing them.
...
It is really recommended that you learn from an experienced navigator, either a 
...
you will develop with practice. Always keep learning!
...
Basic survival s[[kill]]s require practice to cultivate. They require an inquisitive
...
them, as you can. Get out there, stay safe, and good luck!
